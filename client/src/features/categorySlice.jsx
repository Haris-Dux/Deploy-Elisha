...
//API URL
const createCategoryUrl = "/api/createCategory";
const updateCategoryUrl = "/api/updateCategory";
const deleteCategoryUrl = "/api/deleteCategory";
const getAllCategoriesUrl = "/api/getAllCategories";

// CATEGORIES-TYPE API
const createCategoryTypeUrl = "/api/createCategoryType";
const updateCategoryTypeUrl = "/api/updateCategoryType";
const deleteCategoryTypeUrl = "/api/deleteCategoryType";
const getAllCategoryTypesUrl = "/api/getAllCategoryTypes";

// SUB-CATEGORIES TYPE API
const createSubCategoryUrl = "/api/createSubCategory";
const updateSubCategoryUrl = "/api/updateSubCategory";
const deleteSubCategoryUrl = "/api/deleteSubCategory";
const getAllSubCategoriesUrl = "/api/getAllSubCategories";
